...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.AudioGalary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.PhotoAlbum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.PhotoGalary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.ThreeSixtyDegreeGalary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.VideoGalary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.ImageStore", b =>
                {
                    b.HasOne("KaashiYatra.API.Models.AudioGalary", null)
                        .WithMany("Images")
                    ...
                    b.HasOne("KaashiYatra.API.Models.PhotoAlbum", null)
                        .WithMany("Images")
                        .HasForeignKey("PhotoAlbumId");

                    b.HasOne("KaashiYatra.API.Models.PhotoGalary", null)
                        .WithMany("Images")
                    ...
                    b.HasOne("KaashiYatra.API.Models.ThreeSixtyDegreeGalary", null)
                        .WithMany("Images")
                        .HasForeignKey("ThreeSixtyDegreeGalaryId");

                    b.HasOne("KaashiYatra.API.Models.VideoGalary", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.MasterYatra", b =>
                {
                    b.HasOne("KaashiYatra.API.Models.MasterYatra", "ParentYatra")
                        .WithMany()
            ...
            modelBuilder.Entity("KaashiYatra.API.Models.PhotoGalary", b =>
                {
                    b.HasOne("KaashiYatra.API.Models.PhotoAlbum", "PhotoAlbum")
                        .WithMany()
                        .HasForeignKey("PhotoAlbumId");
